...
module ecg_fpga_top_ecg_fpga_top_Pipeline_VITIS_LOOP_29_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   beat_local_1_we0;
output  [15:0] beat_local_1_d0;
output  [7:0] beat_local_address0;
output   beat_local_ce0;
output   beat_local_we0;
output  [15:0] beat_local_d0;
...
wire   [0:0] trunc_ln29_fu_123_p1;
reg   [0:0] trunc_ln29_reg_169;
reg   [0:0] trunc_ln29_reg_169_pp0_iter1_reg;
reg   [7:0] lshr_ln_reg_173;
reg   [7:0] lshr_ln_reg_173_pp0_iter1_reg;
reg   [15:0] gmem0_addr_read_reg_178;
wire   [63:0] zext_ln29_fu_148_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [8:0] i_fu_58;
wire   [8:0] add_ln29_fu_117_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_i_2;
wire    ap_block_pp0_stage0;
reg    beat_local_we0_local;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg    beat_local_ce0_local;
reg    beat_local_1_we0_local;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln_reg_173 <= {{ap_sig_allocacmp_i_2[8:1]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln29_reg_169_pp0_iter1_reg == 1'd1))) begin
        beat_local_1_we0_local = 1'b1;
    end else begin
        beat_local_1_we0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln29_reg_169_pp0_iter1_reg == 1'd0))) begin
        beat_local_we0_local = 1'b1;
    end else begin
        beat_local_we0_local = 1'b0;
    end
end
...
assign add_ln29_fu_117_p2 = (ap_sig_allocacmp_i_2 + 9'd1);
...
assign beat_local_1_address0 = zext_ln29_fu_148_p1;

assign beat_local_1_ce0 = beat_local_1_ce0_local;

assign beat_local_1_d0 = gmem0_addr_read_reg_178;

assign beat_local_1_we0 = beat_local_1_we0_local;

assign beat_local_address0 = zext_ln29_fu_148_p1;

assign beat_local_ce0 = beat_local_ce0_local;

assign beat_local_d0 = gmem0_addr_read_reg_178;

assign beat_local_we0 = beat_local_we0_local;

assign icmp_ln29_fu_111_p2 = ((ap_sig_allocacmp_i_2 == 9'd320) ? 1'b1 : 1'b0);
...
assign trunc_ln29_fu_123_p1 = ap_sig_allocacmp_i_2[0:0];

assign zext_ln29_fu_148_p1 = lshr_ln_reg_173_pp0_iter1_reg;

endmodule //ecg_fpga_top_ecg_fpga_top_Pipeline_VITIS_LOOP_29_1
