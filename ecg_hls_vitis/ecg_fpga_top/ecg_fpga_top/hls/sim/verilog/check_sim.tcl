...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ecg_fpga_top.autotvin_gmem0.dat"
         "c.ecg_fpga_top.autotvin_beat_in_q12.dat"
         "c.ecg_fpga_top.autotvin_pred_class.dat"
         "c.ecg_fpga_top.autotvin_score5_q12.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ecg_fpga_top.autotvout_gmem1.dat"
         "rtl.ecg_fpga_top.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
