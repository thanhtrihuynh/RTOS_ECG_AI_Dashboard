...
if {[file isfile ecg_fpga_top.autotvin.dat]} {
	file delete -force ecg_fpga_top.autotvin.dat
}

if {[file isfile ecg_fpga_top.autotvout.dat]} {
	file delete -force ecg_fpga_top.autotvout.dat
}
