...
`define AUTOTB_DUT      ecg_fpga_top
`define AUTOTB_DUT_INST AESL_inst_ecg_fpga_top
`define AUTOTB_TOP      apatb_ecg_fpga_top_top
`define AUTOTB_LAT_RESULT_FILE "ecg_fpga_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "ecg_fpga_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_ecg_fpga_top_top
...
`define AESL_DEPTH_beat_in_q12 1
`define AESL_DEPTH_pred_class 1
`define AESL_DEPTH_score5_q12 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.ecg_fpga_top.autotvin_gmem0.dat"
`define AUTOTB_TVIN_beat_in_q12_out_wrapc  "../tv/rtldatafile/rtl.ecg_fpga_top.autotvin_beat_in_q12.dat"
`define AUTOTB_TVIN_pred_class_out_wrapc  "../tv/rtldatafile/rtl.ecg_fpga_top.autotvin_pred_class.dat"
`define AUTOTB_TVIN_score5_q12_out_wrapc  "../tv/rtldatafile/rtl.ecg_fpga_top.autotvin_score5_q12.dat"
...
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.ecg_fpga_top.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.ecg_fpga_top.autotvout_gmem2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 739;
parameter LENGTH_beat_in_q12 = 1;
parameter LENGTH_gmem0 = 320;
parameter LENGTH_gmem1 = 1;
parameter LENGTH_gmem2 = 5;
parameter LENGTH_pred_class = 1;
parameter LENGTH_score5_q12 = 1;
