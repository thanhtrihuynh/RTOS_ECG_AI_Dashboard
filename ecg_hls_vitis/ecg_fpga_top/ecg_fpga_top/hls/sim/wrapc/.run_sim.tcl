...
# 
# ==============================================================
set ::env(PATH) "T:/SoC/2025.2/Vitis/win64/tools/fpo_v7_1;$::env(PATH)"
set ::env(PATH) "T:/SoC/2025.2/Vitis/win64/tools/fft_v9_1;$::env(PATH)"
set ::env(PATH) "T:/SoC/2025.2/Vitis/win64/tools/fir_v7_0;$::env(PATH)"
set ::env(PATH) "T:/SoC/2025.2/Vitis/win64/tools/dds_v6_0;$::env(PATH)"
set ::env(PATH) "T:/SoC/2025.2/Vitis/tps/mingw/10.0.0/win64.o/nt/bin;$::env(PATH)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ecg_fpga_top.autotvin.dat"
	set constFileTvOut       "ecg_fpga_top.autotvout.dat"
	set constFileHdlTvIn     "ecg_fpga_top.autohdltvin.dat"
	set constFileHdlTvOut    "ecg_fpga_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
