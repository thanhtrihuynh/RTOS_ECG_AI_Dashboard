...
TOOLCHAIN += --sysroot=T:/SoC/2025.2/Vitis/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/tb_ecg_fpga_top.cpp_pre.cpp.tb.o : tb_ecg_fpga_top.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_ecg_fpga_top.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/ecg_hls_layers.cpp_pre.cpp.tb.o : ecg_hls_layers.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ecg_hls_layers.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ecg_fpga_top.cpp_pre.cpp.tb.o : ecg_fpga_top.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ecg_fpga_top.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
