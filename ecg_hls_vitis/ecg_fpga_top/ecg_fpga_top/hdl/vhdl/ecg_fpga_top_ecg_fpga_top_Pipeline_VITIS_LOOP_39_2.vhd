...
entity ecg_fpga_top_ecg_fpga_top_Pipeline_VITIS_LOOP_39_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ecg_fpga_top_ecg_fpga_top_Pipeline_VITIS_LOOP_39_2 is 
...
attribute shreg_extract : string;
    ...
    signal tmp_fu_150_p13 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_reg_198 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal i_fu_72 : STD_LOGIC_VECTOR (2 downto 0) := "000";
    signal add_ln39_fu_138_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_1 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal tmp_fu_150_p11 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    sparsemux_11_3_16_1_1_U225 : component ecg_fpga_top_sparsemux_11_3_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "000",
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln39_fu_132_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_72 <= add_ln39_fu_138_p2;
    ...
    add_ln39_fu_138_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv3_1));
    ...
    icmp_ln39_fu_132_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv3_5) else "0";
    ...
    m_axi_gmem2_0_WDATA <= tmp_reg_198;
    ...
    tmp_fu_150_p11 <= "XXXXXXXXXXXXXXXX";
end behav;
