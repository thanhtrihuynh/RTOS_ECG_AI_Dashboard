...
module ecg_fpga_top_ecg_fpga_top_Pipeline_VITIS_LOOP_39_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [62:0] sext_ln39;
input  [15:0] best_val;
input  [15:0] best_val_1;
input  [15:0] best_val_3;
input  [15:0] best_val_5;
...
wire   [15:0] tmp_fu_150_p13;
reg   [15:0] tmp_reg_198;
reg    ap_block_pp0_stage0_11001;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [2:0] i_fu_72;
wire   [2:0] add_ln39_fu_138_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_i_1;
wire    ap_block_pp0_stage0;
wire   [15:0] tmp_fu_150_p11;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln39_fu_132_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln39_fu_138_p2 = (ap_sig_allocacmp_i_1 + 3'd1);
...
assign icmp_ln39_fu_132_p2 = ((ap_sig_allocacmp_i_1 == 3'd5) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_0_WDATA = tmp_reg_198;
...
assign tmp_fu_150_p11 = 'bx;

endmodule //ecg_fpga_top_ecg_fpga_top_Pipeline_VITIS_LOOP_39_2
